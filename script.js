// ============================================================
// 1. ДАННЫЕ ТОВАРОВ (локально, без Firebase)
// ============================================================
const productsData = [
    // ========== АМФИБИЯ (9 товаров) ==========
    {
...
// ============================================================
// 2. КОРЗИНА (localStorage + Firebase для синхронизации)
// ============================================================
...
// ============================================================
// 3. ОТРИСОВКА ТОВАРОВ ИЗ ЛОКАЛЬНЫХ ДАННЫХ
// ============================================================
...
// ============================================================
// 6. ПОДСЧЕТ ТОВАРОВ В КАТЕГОРИЯХ
// ============================================================
...
// ============================================================
// 8. ВЫПАДАЮЩИЙ ФИЛЬТР В САЙДБАРЕ
// ============================================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Настройка фильтрации по сериям
    setupSeriesFilters();

    // Настройка выпадающего фильтра
    setupFilterDropdown();
...
// ============================================================
// 11. АДМИН-ПАНЕЛЬ (управление заказами)
// ============================================================
...
// Функция для отрисовки заказов в админ-панели
...
// Функция для создания нового заказа из корзины
function createOrderFromCart() {
    ...
    // Если админ-панель открыта, обновляем её
    const panel = document.getElementById('adminPanel');
...
// ============================================================
// 12. НАСТРОЙКА КНОПОК ДЛЯ АДМИН-ПАНЕЛИ
// ============================================================
document.addEventListener('DOMContentLoaded', function() {
    console.log('🛠 Настройка админ-панели...');
    
    // Кнопка открытия админ-панели (профиль)
    ...
    // Модифицируем кнопку "Перейти к оформлению" для создания заказа
    const goToCheckoutBtn = document.getElementById('goToCheckout');
    if (goToCheckoutBtn) {
